...
p5.registerAddon((p5, fn) => {
  ...
  p5.RendererGL.prototype.tetrahedron = function (...args) {
    ...
    const _vertices = [
      p5.prototype.createVector(center.x, center.y, center.z + length * sqrt8 / 3),
      p5.prototype.createVector(center.x - length / sqrt2, center.y - length / sqrt2, center.z - length / 3),
      p5.prototype.createVector(center.x + length / sqrt2, center.y - length / sqrt2, center.z - length / 3),
      p5.prototype.createVector(center.x, center.y + length / sqrt2, center.z - length / 3)
    ];
  ...
  p5.RendererGL.prototype.dodecahedron = function (...args) {
    ...
    const a = length / p5.prototype.sqrt(3);
    const b = a / phi;
    const c = a * phi;
    const v = (x, y, z) => p5.prototype.createVector(x, y, z).add(center);
    const _vertices = [
...
// Optional: export an object for ESM if needed
// export default {};